     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      COMMON /U1000/ Q0(5),Q1(5),Q2(5)
      DIMENSION DMASS(5),DWIDTH(5)
      SAVE
      DMASS(5)=A(84)
      DWIDTH(5)=A(85)
      Q1(5)=-A(137)**2-A(137)**2+A(84)**2-2*(+P1)
      DMASS(4)=A(82)
      DWIDTH(4)=A(83)
      Q1(4)=-A(137)**2-A(137)**2+A(82)**2-2*(+P1)
      DMASS(3)=A(6)
      DWIDTH(3)=A(15)
      Q1(3)=-A(137)**2-A(137)**2+A(6)**2-2*(+P1)
      DMASS(2)=A(91)
      DWIDTH(2)=A(92)
      Q1(2)=-A(137)**2-A(8)**2+A(91)**2-2*(-P2)
      DMASS(1)=A(89)
      DWIDTH(1)=A(90)
      Q1(1)=-A(137)**2-A(8)**2+A(89)**2-2*(-P2)
      DO 2 I=1,5
      IF (RWIDTH) THEN
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(2)=A(135)
      DWIDTH(2)=A(105)
      Q1(2)=-A(137)**2-A(87)**2+A(135)**2-2*(-P2)
      DMASS(1)=A(134)
      DWIDTH(1)=A(104)
      Q1(1)=-A(137)**2-A(87)**2+A(134)**2-2*(-P2)
      DO 2 I=1,5
      IF (RWIDTH) THEN
        Q2(I)=1/(Q1(I)**2+((DMASS(I)-Q1(I)/DMASS(I))*DWIDTH(I))**2)
      ELSE
...
2     CONTINUE
      ...
      COMMON/SCLR/P1,P2,P3,P4,P5,P6,P7,P8,P9,PA,PB,PC,PD,PE,PF,PG,PH
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      COMMON /U102/ Q0(5),Q1(6),Q2(6)
      DIMENSION DMASS(5),DWIDTH(5)
      SAVE
      Q1(6)=-A(93)**2-A(137)**2-2*(+P1)
      DMASS(5)=A(137)
      DWIDTH(5)=A(111)
      Q1(5)=-A(93)**2+A(137)**2-2*(-P4)
      DMASS(4)=A(99)
      DWIDTH(4)=A(100)
...
2     CONTINUE
      ...
      COMMON/SCLR/P1,P2,P3,P4,P5,P6,P7,P8,P9,PA,PB,PC,PD,PE,PF,PG,PH
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      COMMON /U103/ Q0(3),Q1(4),Q2(4)
      DIMENSION DMASS(3),DWIDTH(3)
      SAVE
      Q1(4)=-A(93)**2-A(137)**2-2*(+P1)
      DMASS(3)=A(134)
      DWIDTH(3)=A(104)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(8)=A(99)
      DWIDTH(8)=A(100)
      Q1(8)=-A(112)**2+A(99)**2-2*(-P4)
      DMASS(7)=A(99)
      DWIDTH(7)=A(100)
      Q1(7)=-A(112)**2+A(99)**2-2*(-P2)
      DMASS(6)=A(97)
      DWIDTH(6)=A(98)
      Q1(6)=-A(112)**2+A(97)**2-2*(-P4)
      DMASS(5)=A(97)
      DWIDTH(5)=A(98)
      Q1(5)=-A(112)**2+A(97)**2-2*(-P2)
      DMASS(4)=A(95)
      DWIDTH(4)=A(96)
      Q1(4)=-A(112)**2+A(95)**2-2*(-P4)
      DMASS(3)=A(95)
      DWIDTH(3)=A(96)
      Q1(3)=-A(112)**2+A(95)**2-2*(-P2)
      DMASS(2)=A(93)
      DWIDTH(2)=A(94)
      Q1(2)=-A(112)**2+A(93)**2-2*(-P4)
      DMASS(1)=A(93)
      DWIDTH(1)=A(94)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(4)=A(84)
      DWIDTH(4)=A(85)
      Q1(4)=-A(112)**2-A(112)**2+A(84)**2-2*(+P1)
      DMASS(3)=A(82)
      DWIDTH(3)=A(83)
      Q1(3)=-A(112)**2-A(112)**2+A(82)**2-2*(+P1)
      DMASS(2)=A(112)
      DWIDTH(2)=A(113)
      Q1(2)=-A(6)**2-2*(-P4)
      DMASS(1)=A(112)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(2)=A(6)
      DWIDTH(2)=A(15)
      Q1(2)=-A(112)**2-A(112)**2+A(6)**2-2*(+P1)
      DMASS(1)=A(112)
      DWIDTH(1)=A(113)
      Q1(1)=-A(6)**2-2*(-P2)
      DO 2 I=1,3
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(2)=A(84)
      DWIDTH(2)=A(85)
      Q1(2)=-A(112)**2-A(112)**2+A(84)**2-2*(+P1)
      DMASS(1)=A(82)
      DWIDTH(1)=A(83)
      Q1(1)=-A(112)**2-A(112)**2+A(82)**2-2*(+P1)
      DO 2 I=1,2
      IF (RWIDTH) THEN
        Q2(I)=1/(Q1(I)**2+((DMASS(I)-Q1(I)/DMASS(I))*DWIDTH(I))**2)
      ELSE
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(5)=A(84)
      DWIDTH(5)=A(85)
      Q1(5)=-A(112)**2-A(112)**2+A(84)**2-2*(+P1)
      DMASS(4)=A(82)
      DWIDTH(4)=A(83)
      Q1(4)=-A(112)**2-A(112)**2+A(82)**2-2*(+P1)
      DMASS(3)=A(6)
      DWIDTH(3)=A(15)
      Q1(3)=-A(112)**2-A(112)**2+A(6)**2-2*(+P1)
      DMASS(2)=A(108)
      DWIDTH(2)=A(109)
      Q1(2)=-A(112)**2-A(151)**2+A(108)**2-2*(-P2)
      DMASS(1)=A(106)
      DWIDTH(1)=A(107)
      Q1(1)=-A(112)**2-A(151)**2+A(106)**2-2*(-P2)
      DO 2 I=1,5
      IF (RWIDTH) THEN
        Q2(I)=1/(Q1(I)**2+((DMASS(I)-Q1(I)/DMASS(I))*DWIDTH(I))**2)
      ELSE
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(2)=A(108)
      DWIDTH(2)=A(109)
      Q1(2)=-A(112)**2-A(87)**2+A(108)**2-2*(-P4)
      DMASS(1)=A(106)
      DWIDTH(1)=A(107)
      Q1(1)=-A(112)**2-A(87)**2+A(106)**2-2*(-P4)
      DO 2 I=1,4
      IF (RWIDTH) THEN
        Q2(I)=1/(Q1(I)**2+((DMASS(I)-Q1(I)/DMASS(I))*DWIDTH(I))**2)
      ELSE
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(1)=A(6)
      DWIDTH(1)=A(15)
      Q1(1)=-A(112)**2-A(112)**2+A(6)**2-2*(+P1)
      DO 2 I=1,1
      IF (RWIDTH) THEN
        Q2(I)=1/(Q1(I)**2+((DMASS(I)-Q1(I)/DMASS(I))*DWIDTH(I))**2)
      ELSE
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(5)=A(6)
      DWIDTH(5)=A(15)
      Q1(5)=-A(112)**2-A(112)**2+A(6)**2-2*(+P1)
      DMASS(4)=A(99)
      DWIDTH(4)=A(100)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(3)=A(84)
      DWIDTH(3)=A(85)
      Q1(3)=-A(112)**2-A(112)**2+A(84)**2-2*(+P1)
      DMASS(2)=A(82)
      DWIDTH(2)=A(83)
      Q1(2)=-A(112)**2-A(112)**2+A(82)**2-2*(+P1)
      DMASS(1)=A(6)
      DWIDTH(1)=A(15)
      Q1(1)=-A(112)**2-A(112)**2+A(6)**2-2*(+P1)
      DO 2 I=1,3
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(2)=A(108)
      DWIDTH(2)=A(109)
      Q1(2)=-A(112)**2-A(87)**2+A(108)**2-2*(-P2)
      DMASS(1)=A(106)
      DWIDTH(1)=A(107)
      Q1(1)=-A(112)**2-A(87)**2+A(106)**2-2*(-P2)
      DO 2 I=1,5
      IF (RWIDTH) THEN
        Q2(I)=1/(Q1(I)**2+((DMASS(I)-Q1(I)/DMASS(I))*DWIDTH(I))**2)
      ELSE
...
2     CONTINUE
      ...
      COMMON/SCLR/P1,P2,P3,P4,P5,P6,P7,P8,P9,PA,PB,PC,PD,PE,PF,PG,PH
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      COMMON /U107/ Q0(4),Q1(5),Q2(5)
      DIMENSION DMASS(4),DWIDTH(4)
      SAVE
      Q1(5)=-A(93)**2-A(137)**2-2*(+P1)
      DMASS(4)=A(135)
      DWIDTH(4)=A(105)
      Q1(4)=-A(93)**2-A(8)**2+A(135)**2-2*(-P2)
      DMASS(3)=A(134)
      DWIDTH(3)=A(104)
      Q1(3)=-A(93)**2-A(8)**2+A(134)**2-2*(-P2)
      DMASS(2)=A(91)
      DWIDTH(2)=A(92)
      Q1(2)=-A(93)**2-A(87)**2+A(91)**2-2*(-P4)
      DMASS(1)=A(89)
...
2     CONTINUE
      ...
      COMMON/SCLR/P1,P2,P3,P4,P5,P6,P7,P8,P9,PA,PB,PC,PD,PE,PF,PG,PH
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      COMMON /U108/ Q0(5),Q1(6),Q2(6)
      DIMENSION DMASS(5),DWIDTH(5)
      SAVE
      Q1(6)=-A(93)**2-A(112)**2-2*(+P1)
      DMASS(5)=A(112)
      DWIDTH(5)=A(113)
      Q1(5)=-A(93)**2+A(112)**2-2*(-P4)
      DMASS(4)=A(99)
      DWIDTH(4)=A(100)
      Q1(4)=-A(93)**2-A(6)**2+A(99)**2-2*(-P2)
      DMASS(3)=A(97)
