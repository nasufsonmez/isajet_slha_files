...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(6)=A(87)
      DWIDTH(6)=A(88)
      Q1(6)=-A(140)**2-A(122)**2+A(87)**2-2*(+P1)
      DMASS(5)=A(151)
      DWIDTH(5)=A(16)
      Q1(5)=-A(140)**2-A(122)**2+A(151)**2-2*(+P1)
      DMASS(4)=A(99)
      DWIDTH(4)=A(100)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(2)=A(151)
      DWIDTH(2)=A(16)
      Q1(2)=-A(140)**2-A(122)**2+A(151)**2-2*(+P1)
      DMASS(1)=A(140)
      DWIDTH(1)=A(116)
      Q1(1)=-A(82)**2-2*(-P2)
      DO 2 I=1,5
...
2     CONTINUE
      ...
      COMMON/SCLR/P1,P2,P3,P4,P5,P6,P7,P8,P9,PA,PB,PC,PD,PE,PF,PG,PH
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      COMMON /U1409/ Q0(2),Q1(2),Q2(2)
      DIMENSION DMASS(2),DWIDTH(2)
      SAVE
      DMASS(2)=A(124)
      DWIDTH(2)=A(125)
      Q1(2)=-A(140)**2-A(87)**2+A(124)**2-2*(-P4)
      DMASS(1)=A(151)
      DWIDTH(1)=A(16)
      Q1(1)=-A(140)**2-A(122)**2+A(151)**2-2*(+P1)
      DO 2 I=1,2
...
2     CONTINUE
      ...
      COMMON/SCLR/P1,P2,P3,P4,P5,P6,P7,P8,P9,PA,PB,PC,PD,PE,PF,PG,PH
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      COMMON /U140/ Q0(3),Q1(4),Q2(4)
      DIMENSION DMASS(3),DWIDTH(3)
      SAVE
      Q1(4)=-A(93)**2-A(142)**2+A(10)**2-2*(+P1)
      DMASS(3)=A(140)
      DWIDTH(3)=A(116)
...
3     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(1)=A(142)
      DWIDTH(1)=A(118)
      Q1(1)=-A(140)**2-A(151)**2+A(142)**2-2*(-P2)
      Q1(2)=-A(140)**2-A(131)**2-2*(+P1)
      DO 2 I=1,1
      IF (RWIDTH) THEN
        Q2(I)=1/(Q1(I)**2+((DMASS(I)-Q1(I)/DMASS(I))*DWIDTH(I))**2)
...
3     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(1)=A(122)
      DWIDTH(1)=A(123)
      Q1(1)=-A(140)**2-A(151)**2+A(122)**2-2*(-P2)
      Q1(3)=-A(140)**2-A(131)**2-2*(+P1)
      DO 2 I=1,2
      IF (RWIDTH) THEN
        Q2(I)=1/(Q1(I)**2+((DMASS(I)-Q1(I)/DMASS(I))*DWIDTH(I))**2)
      ELSE
...
3     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      Q1(5)=-A(93)**2-A(142)**2+A(10)**2-2*(+P1)
      DMASS(2)=A(91)
      DWIDTH(2)=A(92)
      Q1(2)=-A(93)**2-A(151)**2+A(91)**2-2*(-P2)
      DMASS(1)=A(89)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(1)=A(142)
      DWIDTH(1)=A(118)
      Q1(1)=-A(140)**2-A(87)**2+A(142)**2-2*(-P4)
      Q1(3)=-A(140)**2-A(131)**2-2*(+P1)
      DO 2 I=1,2
      IF (RWIDTH) THEN
        Q2(I)=1/(Q1(I)**2+((DMASS(I)-Q1(I)/DMASS(I))*DWIDTH(I))**2)
...
3     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(1)=A(122)
      DWIDTH(1)=A(123)
      Q1(1)=-A(140)**2-A(87)**2+A(122)**2-2*(-P4)
      Q1(3)=-A(140)**2-A(131)**2-2*(+P1)
      DO 2 I=1,2
      IF (RWIDTH) THEN
        Q2(I)=1/(Q1(I)**2+((DMASS(I)-Q1(I)/DMASS(I))*DWIDTH(I))**2)
...
3     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(10)=A(131)
      DWIDTH(10)=A(101)
      Q1(10)=-A(142)**2-A(10)**2+A(131)**2-2*(-P2)
      DMASS(9)=A(131)
      DWIDTH(9)=A(101)
      Q1(9)=-A(142)**2-A(10)**2+A(131)**2-2*(-P4)
      DMASS(8)=A(99)
      DWIDTH(8)=A(100)
      Q1(8)=-A(142)**2-A(10)**2+A(99)**2-2*(-P4)
      DMASS(7)=A(99)
      DWIDTH(7)=A(100)
      Q1(7)=-A(142)**2-A(10)**2+A(99)**2-2*(-P2)
      DMASS(6)=A(97)
      DWIDTH(6)=A(98)
      Q1(6)=-A(142)**2-A(10)**2+A(97)**2-2*(-P4)
      DMASS(5)=A(97)
      DWIDTH(5)=A(98)
      Q1(5)=-A(142)**2-A(10)**2+A(97)**2-2*(-P2)
      DMASS(4)=A(95)
      DWIDTH(4)=A(96)
      Q1(4)=-A(142)**2-A(10)**2+A(95)**2-2*(-P4)
      DMASS(3)=A(95)
      DWIDTH(3)=A(96)
      Q1(3)=-A(142)**2-A(10)**2+A(95)**2-2*(-P2)
      DMASS(2)=A(93)
      DWIDTH(2)=A(94)
      Q1(2)=-A(142)**2-A(10)**2+A(93)**2-2*(-P4)
      DMASS(1)=A(93)
      DWIDTH(1)=A(94)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(4)=A(84)
      DWIDTH(4)=A(85)
      Q1(4)=-A(142)**2-A(142)**2+A(84)**2-2*(+P1)
      DMASS(3)=A(82)
      DWIDTH(3)=A(83)
      Q1(3)=-A(142)**2-A(142)**2+A(82)**2-2*(+P1)
      DMASS(2)=A(142)
      DWIDTH(2)=A(118)
      Q1(2)=-A(6)**2-2*(-P4)
      DMASS(1)=A(142)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(2)=A(6)
      DWIDTH(2)=A(15)
      Q1(2)=-A(142)**2-A(142)**2+A(6)**2-2*(+P1)
      DMASS(1)=A(142)
      DWIDTH(1)=A(118)
      Q1(1)=-A(6)**2-2*(-P2)
      DO 2 I=1,3
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(2)=A(84)
      DWIDTH(2)=A(85)
      Q1(2)=-A(142)**2-A(142)**2+A(84)**2-2*(+P1)
      DMASS(1)=A(82)
      DWIDTH(1)=A(83)
      Q1(1)=-A(142)**2-A(142)**2+A(82)**2-2*(+P1)
      DO 2 I=1,2
      IF (RWIDTH) THEN
        Q2(I)=1/(Q1(I)**2+((DMASS(I)-Q1(I)/DMASS(I))*DWIDTH(I))**2)
      ELSE
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(7)=A(128)
      DWIDTH(7)=A(129)
      Q1(7)=-A(142)**2-A(151)**2+A(128)**2-2*(-P2)
      DMASS(6)=A(126)
      DWIDTH(6)=A(127)
      Q1(6)=-A(142)**2-A(151)**2+A(126)**2-2*(-P2)
      DMASS(5)=A(144)
      DWIDTH(5)=A(120)
      Q1(5)=-A(142)**2-A(151)**2+A(144)**2-2*(-P2)
      DMASS(4)=A(84)
      DWIDTH(4)=A(85)
      Q1(4)=-A(142)**2-A(142)**2+A(84)**2-2*(+P1)
      DMASS(3)=A(82)
...
3     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(6)=A(128)
      DWIDTH(6)=A(129)
      Q1(6)=-A(142)**2-A(151)**2+A(128)**2-2*(-P2)
      DMASS(5)=A(126)
      DWIDTH(5)=A(127)
      Q1(5)=-A(142)**2-A(151)**2+A(126)**2-2*(-P2)
      DMASS(4)=A(144)
      DWIDTH(4)=A(120)
      Q1(4)=-A(142)**2-A(151)**2+A(144)**2-2*(-P2)
      DMASS(3)=A(84)
      DWIDTH(3)=A(85)
      Q1(3)=-A(142)**2-A(142)**2+A(84)**2-2*(+P1)
      DMASS(2)=A(82)
      DWIDTH(2)=A(83)
      Q1(2)=-A(142)**2-A(142)**2+A(82)**2-2*(+P1)
      DMASS(1)=A(140)
      DWIDTH(1)=A(116)
      Q1(1)=-A(142)**2-A(151)**2+A(140)**2-2*(-P2)
      DO 2 I=1,6
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(5)=A(126)
      DWIDTH(5)=A(127)
      Q1(5)=-A(142)**2-A(87)**2+A(126)**2-2*(-P4)
      DMASS(4)=A(144)
      DWIDTH(4)=A(120)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(1)=A(6)
      DWIDTH(1)=A(15)
      Q1(1)=-A(142)**2-A(142)**2+A(6)**2-2*(+P1)
      DO 2 I=1,1
      IF (RWIDTH) THEN
        Q2(I)=1/(Q1(I)**2+((DMASS(I)-Q1(I)/DMASS(I))*DWIDTH(I))**2)
      ELSE
...
3     CONTINUE
      ...
      COMMON/SCLR/P1,P2,P3,P4,P5,P6,P7,P8,P9,PA,PB,PC,PD,PE,PF,PG,PH
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      COMMON /U145/ Q0(6),Q1(7),Q2(7)
      DIMENSION DMASS(6),DWIDTH(6)
      SAVE
      DMASS(6)=A(143)
      DWIDTH(6)=A(119)
      Q1(6)=-A(93)**2-A(10)**2+A(143)**2-2*(-P2)
      Q1(7)=-A(93)**2-A(142)**2+A(10)**2-2*(+P1)
      DMASS(5)=A(142)
      DWIDTH(5)=A(118)
      Q1(5)=-A(93)**2-A(10)**2+A(142)**2-2*(-P2)
      DMASS(4)=A(99)
      DWIDTH(4)=A(100)
...
3     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(3)=A(6)
      DWIDTH(3)=A(15)
      Q1(3)=-A(142)**2-A(142)**2+A(6)**2-2*(+P1)
      Q1(4)=-A(142)**2-A(142)**2-2*(+P1)
      DMASS(2)=A(91)
      DWIDTH(2)=A(92)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(8)=A(131)
      DWIDTH(8)=A(101)
      Q1(8)=-A(142)**2-A(10)**2+A(131)**2-2*(-P2)
      DMASS(7)=A(84)
      DWIDTH(7)=A(85)
      Q1(7)=-A(142)**2-A(142)**2+A(84)**2-2*(+P1)
      DMASS(6)=A(82)
      DWIDTH(6)=A(83)
      Q1(6)=-A(142)**2-A(142)**2+A(82)**2-2*(+P1)
      DMASS(5)=A(6)
      DWIDTH(5)=A(15)
      Q1(5)=-A(142)**2-A(142)**2+A(6)**2-2*(+P1)
      Q1(9)=-A(142)**2-A(142)**2-2*(+P1)
      DMASS(4)=A(99)
      DWIDTH(4)=A(100)
...
3     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(5)=A(84)
      DWIDTH(5)=A(85)
      Q1(5)=-A(142)**2-A(142)**2+A(84)**2-2*(+P1)
      DMASS(4)=A(82)
      DWIDTH(4)=A(83)
      Q1(4)=-A(142)**2-A(142)**2+A(82)**2-2*(+P1)
      DMASS(3)=A(6)
      DWIDTH(3)=A(15)
      Q1(3)=-A(142)**2-A(142)**2+A(6)**2-2*(+P1)
      Q1(6)=-A(142)**2-A(142)**2-2*(+P1)
      DMASS(2)=A(91)
      DWIDTH(2)=A(92)
...
3     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(6)=A(143)
      DWIDTH(6)=A(119)
      Q1(6)=-A(142)**2-A(82)**2+A(143)**2-2*(-P4)
      DMASS(5)=A(143)
      DWIDTH(5)=A(119)
      Q1(5)=-A(142)**2-A(82)**2+A(143)**2-2*(-P2)
      DMASS(4)=A(84)
      DWIDTH(4)=A(85)
      Q1(4)=-A(142)**2-A(142)**2+A(84)**2-2*(+P1)
      DMASS(3)=A(82)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(6)=A(143)
      DWIDTH(6)=A(119)
      Q1(6)=-A(142)**2-A(84)**2+A(143)**2-2*(-P4)
      DMASS(5)=A(143)
      DWIDTH(5)=A(119)
      Q1(5)=-A(142)**2-A(82)**2+A(143)**2-2*(-P2)
      DMASS(4)=A(84)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(3)=A(143)
      DWIDTH(3)=A(119)
      Q1(3)=-A(142)**2-A(7)**2+A(143)**2-2*(-P4)
      DMASS(2)=A(143)
      DWIDTH(2)=A(119)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(6)=A(143)
      DWIDTH(6)=A(119)
      Q1(6)=-A(142)**2-A(84)**2+A(143)**2-2*(-P2)
      DMASS(5)=A(142)
      DWIDTH(5)=A(118)
      Q1(5)=-A(84)**2-2*(-P2)
      DMASS(4)=A(143)
      DWIDTH(4)=A(119)
      Q1(4)=-A(142)**2-A(84)**2+A(143)**2-2*(-P4)
      DMASS(3)=A(84)
      DWIDTH(3)=A(85)
      Q1(3)=-A(142)**2-A(142)**2+A(84)**2-2*(+P1)
      DMASS(2)=A(142)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(4)=A(143)
      DWIDTH(4)=A(119)
      Q1(4)=-A(142)**2-A(7)**2+A(143)**2-2*(-P2)
      DMASS(3)=A(143)
      DWIDTH(3)=A(119)
      Q1(3)=-A(142)**2-A(7)**2+A(143)**2-2*(-P4)
      DMASS(2)=A(84)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(8)=A(128)
      DWIDTH(8)=A(129)
      Q1(8)=-A(142)**2-A(87)**2+A(128)**2-2*(-P2)
      DMASS(7)=A(126)
      DWIDTH(7)=A(127)
      Q1(7)=-A(142)**2-A(87)**2+A(126)**2-2*(-P2)
      DMASS(6)=A(145)
      DWIDTH(6)=A(121)
      Q1(6)=-A(142)**2-A(87)**2+A(145)**2-2*(-P2)
      DMASS(5)=A(144)
      DWIDTH(5)=A(120)
      Q1(5)=-A(142)**2-A(87)**2+A(144)**2-2*(-P2)
      DMASS(4)=A(84)
      DWIDTH(4)=A(85)
      Q1(4)=-A(142)**2-A(142)**2+A(84)**2-2*(+P1)
      DMASS(3)=A(82)
...
2     CONTINUE
      ...
      COMMON/SCLR/P1,P2,P3,P4,P5,P6,P7,P8,P9,PA,PB,PC,PD,PE,PF,PG,PH
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      COMMON /U147/ Q0(5),Q1(6),Q2(6)
      DIMENSION DMASS(5),DWIDTH(5)
      SAVE
      DMASS(5)=A(143)
      DWIDTH(5)=A(119)
      Q1(5)=-A(93)**2-A(10)**2+A(143)**2-2*(-P2)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(2)=A(144)
      DWIDTH(2)=A(120)
      Q1(2)=-A(142)**2-A(151)**2+A(144)**2-2*(-P4)
      DMASS(1)=A(142)
      DWIDTH(1)=A(118)
      Q1(1)=-2*(-P2)
      DO 2 I=1,3
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(3)=A(87)
      DWIDTH(3)=A(88)
      Q1(3)=-A(142)**2-A(144)**2+A(87)**2-2*(+P1)
      DMASS(2)=A(144)
      DWIDTH(2)=A(120)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(4)=A(87)
      DWIDTH(4)=A(88)
      Q1(4)=-A(142)**2-A(144)**2+A(87)**2-2*(+P1)
      DMASS(3)=A(151)
      DWIDTH(3)=A(16)
      Q1(3)=-A(142)**2-A(144)**2+A(151)**2-2*(+P1)
      DMASS(2)=A(144)
...
2     CONTINUE
     ...
     .,PI,PJ,PK,PL,PM,PN,PO,PP,PQ,PR,PS
      ...
      DMASS(1)=A(87)
      DWIDTH(1)=A(88)
      Q1(1)=-A(142)**2-A(144)**2+A(87)**2-2*(+P1)
      DO 2 I=1,1
      IF (RWIDTH) THEN
        Q2(I)=1/(Q1(I)**2+((DMASS(I)-Q1(I)/DMASS(I))*DWIDTH(I))**2)
      ELSE
